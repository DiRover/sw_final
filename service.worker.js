...
precacheAndRoute([{'revision':'8b376560126f0eb5e299afe0cef7b585','url':'./index.html'},{'revision':'921d507a772f5755c6f879318b3a8152','url':'main.css'},{'revision':'b18598da5261ebc512d0f3d060bdfd48','url':'main.js'}]); //необязательная строка, нужна чтобы кэшировать файлы

var CACHE_NAME = 'v1'; //имя кэша

var responseCache = new Response(JSON.stringify(data)); //для записи в кэш, т.к. это инфа из файла, а не сам файл, то из неё нужно создать запрос
...
self.addEventListener('fetch', function (evt) {
  ...
  evt.respondWith(_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    var cache, client, response, _responseCache;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 18:
            ...
            //если ответ в кэше есть для данного адреса
            client.postMessage('cache'); //отправляем сообщение клиенту, что ответ из кэша

            return _context3.abrupt("return", _responseCache);
          ...
          case 24:
            ...
            console.log(_context3.t0); //ловим какую-нить ошибку
